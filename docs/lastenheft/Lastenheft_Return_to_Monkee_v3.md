...
### 16.7 Fachliches Datenmodell / Klassendiagramm

![Fachliches Datenmodell / Klassendiagramm](../diagramme/Klassendiagramm/domain_model_class-diagram.drawio.svg)

Quelle:

- [domain_model_class-diagram.drawio](../diagramme/Klassendiagramm/domain_model_class-diagram.drawio)

Das Klassendiagramm konkretisiert das fachliche Datenmodell des MVP und zeigt die zentralen Objekte, die Regeln, Erinnerungen, Ereignisse, Einstellungen und einfache Statistiken abbilden. Es verbindet die fachlichen Anforderungen aus Abschnitt 11 mit einer umsetzungsnahen Sicht auf persistierbare Entitäten und Modellobjekte.

Fachliche Kernaussagen:

- Regeln werden über eine gemeinsame Regelbasis modelliert und für Zeitlimits konkretisiert
- Reminder und Benachrichtigungsereignisse bilden Schlafenszeit- und Bewegungspausen-Workflows ab
- Tagesstatistiken bündeln bestätigte bzw. ignorierte Erinnerungen sowie eingehaltene oder überschrittene Limits
- Nutzerziele, Onboarding- und Nutzereinstellungen werden lokal gespeichert
- das Datenmodell bleibt MVP-tauglich und unterstützt die lokale SQLite-Persistenz ohne Account- oder Cloud-Abhängigkeit

### 16.8 Weitere optionale Diagramme

Für spätere Projektphasen können detaillierte Sequenzdiagramme für Benachrichtigungen und Statistikaggregation ergänzt werden. Für den aktuellen MVP-Dokumentationsstand sind die in Abschnitt 16.1 bis 16.7 eingebundenen Diagramme vollständig.
